class Algori < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/wanfranklin/algori/releases/download/v1.1.0/algori-macos-arm64"
      sha256 "8d63c5dc83911ee575b62fb773b45e6e9364f0abd5cd9fce4f6566ccc5f02dd2"
    end
    on_intel do
      url "https://github.com/wanfranklin/algori/releases/download/v1.1.0/algori-macos-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/wanfranklin/algori/releases/download/v1.1.0/algori-linux-arm64"
      sha256 "3b7dae139f141b5c013dfd2fd5c7d76fd8dfe744df26e1fea10c2c28af2d92ae"
    end
    on_intel do
      url "https://github.com/wanfranklin/algori/releases/download/v1.1.0/algori-linux-x64"
  ...
  test do
    assert_match "1.1.0", shell_output("#{bin}/algori --version")
  end
end
